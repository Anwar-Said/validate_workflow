# first_pipeline_decomposed Workflow Description 
...
```
cwltool --no-match-user --no-read-only --tmpdir $PWD --preserve-environment LEAP_CLI_DIR first_pipeline_decomposed.cwl.json --PDPiD ... 
```